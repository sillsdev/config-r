...
// 2) I tried just using tsup instead of vitejs for the actual library build, but then of course it has its own quirks to work though and seems like a bad idea.
